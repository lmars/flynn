...
func (Key_Algorithm) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_367072455c71aedc, []int{21, 0}
}
...
func (StaticCertificate_Status) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_367072455c71aedc, []int{23, 0}
}
...
func (ManagedCertificate_ValidationMethod) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_367072455c71aedc, []int{24, 0}
}
...
func (ManagedCertificate_Status) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_367072455c71aedc, []int{24, 1}
}
...
func (m *CreateACMEAccountRequest) GetAccount() *ACMEAccount {
	if m != nil {
		return m.Account
	}
	return nil
...
func (m *CreateACMEAccountRequest) GetPrivateKey() []byte {
	if m != nil {
		return m.PrivateKey
	}
	return nil
...
type CreateACMEAccountResponse struct {
	Account              *ACMEAccount `protobuf:"bytes,1,opt,name=account,proto3" json:"account,omitempty"`
	XXX_NoUnkeyedLiteral struct{}     `json:"-"`
	XXX_unrecognized     []byte       `json:"-"`
	XXX_sizecache        int32        `json:"-"`
...
func (m *CreateACMEAccountResponse) Reset()         { *m = CreateACMEAccountResponse{} }
func (m *CreateACMEAccountResponse) String() string { return proto.CompactTextString(m) }
func (*CreateACMEAccountResponse) ProtoMessage()    {}
func (*CreateACMEAccountResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_367072455c71aedc, []int{15}
}

func (m *CreateACMEAccountResponse) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_CreateACMEAccountResponse.Unmarshal(m, b)
}
func (m *CreateACMEAccountResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_CreateACMEAccountResponse.Marshal(b, m, deterministic)
}
func (m *CreateACMEAccountResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CreateACMEAccountResponse.Merge(m, src)
}
func (m *CreateACMEAccountResponse) XXX_Size() int {
	return xxx_messageInfo_CreateACMEAccountResponse.Size(m)
}
func (m *CreateACMEAccountResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_CreateACMEAccountResponse.DiscardUnknown(m)
}

var xxx_messageInfo_CreateACMEAccountResponse proto.InternalMessageInfo

func (m *CreateACMEAccountResponse) GetAccount() *ACMEAccount {
	if m != nil {
		return m.Account
	}
	return nil
...
type GetACMEAccountKeyRequest struct {
	Name                 string   `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
...
func (m *GetACMEAccountKeyRequest) Reset()         { *m = GetACMEAccountKeyRequest{} }
func (m *GetACMEAccountKeyRequest) String() string { return proto.CompactTextString(m) }
func (*GetACMEAccountKeyRequest) ProtoMessage()    {}
func (*GetACMEAccountKeyRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_367072455c71aedc, []int{16}
}

func (m *GetACMEAccountKeyRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_GetACMEAccountKeyRequest.Unmarshal(m, b)
}
func (m *GetACMEAccountKeyRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_GetACMEAccountKeyRequest.Marshal(b, m, deterministic)
}
func (m *GetACMEAccountKeyRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetACMEAccountKeyRequest.Merge(m, src)
}
func (m *GetACMEAccountKeyRequest) XXX_Size() int {
	return xxx_messageInfo_GetACMEAccountKeyRequest.Size(m)
}
func (m *GetACMEAccountKeyRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_GetACMEAccountKeyRequest.DiscardUnknown(m)
}

var xxx_messageInfo_GetACMEAccountKeyRequest proto.InternalMessageInfo

func (m *GetACMEAccountKeyRequest) GetName() string {
	if m != nil {
		return m.Name
	}
	return ""
...
type GetACMEAccountKeyResponse struct {
	PrivateKey           []byte   `protobuf:"bytes,1,opt,name=private_key,json=privateKey,proto3" json:"private_key,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
...
func (m *GetACMEAccountKeyResponse) Reset()         { *m = GetACMEAccountKeyResponse{} }
func (m *GetACMEAccountKeyResponse) String() string { return proto.CompactTextString(m) }
func (*GetACMEAccountKeyResponse) ProtoMessage()    {}
func (*GetACMEAccountKeyResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_367072455c71aedc, []int{17}
}

func (m *GetACMEAccountKeyResponse) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_GetACMEAccountKeyResponse.Unmarshal(m, b)
}
func (m *GetACMEAccountKeyResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_GetACMEAccountKeyResponse.Marshal(b, m, deterministic)
}
func (m *GetACMEAccountKeyResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetACMEAccountKeyResponse.Merge(m, src)
}
func (m *GetACMEAccountKeyResponse) XXX_Size() int {
	return xxx_messageInfo_GetACMEAccountKeyResponse.Size(m)
}
func (m *GetACMEAccountKeyResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_GetACMEAccountKeyResponse.DiscardUnknown(m)
}

var xxx_messageInfo_GetACMEAccountKeyResponse proto.InternalMessageInfo

func (m *GetACMEAccountKeyResponse) GetPrivateKey() []byte {
	if m != nil {
		return m.PrivateKey
	}
	return nil
...
func (*Route_HTTP_StickySessions) Descriptor() ([]byte, []int) {
	return fileDescriptor_367072455c71aedc, []int{20, 2, 0}
}
...
func (*Route_TCP) Descriptor() ([]byte, []int) {
	return fileDescriptor_367072455c71aedc, []int{20, 3}
}
...
func (*Route_TCPPort) Descriptor() ([]byte, []int) {
	return fileDescriptor_367072455c71aedc, []int{20, 4}
}
...
func (*Key) Descriptor() ([]byte, []int) {
	return fileDescriptor_367072455c71aedc, []int{21}
}
...
func (*Certificate) Descriptor() ([]byte, []int) {
	return fileDescriptor_367072455c71aedc, []int{22}
}
...
func (*StaticCertificate) Descriptor() ([]byte, []int) {
	return fileDescriptor_367072455c71aedc, []int{23}
}
...
func (*ManagedCertificate) Descriptor() ([]byte, []int) {
	return fileDescriptor_367072455c71aedc, []int{24}
}
...
func (*ManagedCertificate_Error) Descriptor() ([]byte, []int) {
	return fileDescriptor_367072455c71aedc, []int{24, 2}
}
...
func (*ACMEAccount) Descriptor() ([]byte, []int) {
	return fileDescriptor_367072455c71aedc, []int{25}
}
...
func init() {
	...
	proto.RegisterType((*CreateACMEAccountRequest)(nil), "flynn.api.v1.CreateACMEAccountRequest")
	proto.RegisterType((*CreateACMEAccountResponse)(nil), "flynn.api.v1.CreateACMEAccountResponse")
	proto.RegisterType((*GetACMEAccountKeyRequest)(nil), "flynn.api.v1.GetACMEAccountKeyRequest")
	proto.RegisterType((*GetACMEAccountKeyResponse)(nil), "flynn.api.v1.GetACMEAccountKeyResponse")
	...
	proto.RegisterType((*ACMEAccount)(nil), "flynn.api.v1.ACMEAccount")
}
...
var fileDescriptor_367072455c71aedc = []byte{
	...
	,
}
...
type RouterClient interface {
	...
	CreateACMEAccount(ctx context.Context, in *CreateACMEAccountRequest, opts ...grpc.CallOption) (*CreateACMEAccountResponse, error)
	// Internal only. Get an ACME Account key
	GetACMEAccountKey(ctx context.Context, in *GetACMEAccountKeyRequest, opts ...grpc.CallOption) (*GetACMEAccountKeyResponse, error)
}
...
func (c *routerClient) CreateACMEAccount(ctx context.Context, in *CreateACMEAccountRequest, opts ...grpc.CallOption) (*CreateACMEAccountResponse, error) {
	out := new(CreateACMEAccountResponse)
	err := c.cc.Invoke(ctx, "/flynn.api.v1.Router/CreateACMEAccount", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *routerClient) GetACMEAccountKey(ctx context.Context, in *GetACMEAccountKeyRequest, opts ...grpc.CallOption) (*GetACMEAccountKeyResponse, error) {
	out := new(GetACMEAccountKeyResponse)
	err := c.cc.Invoke(ctx, "/flynn.api.v1.Router/GetACMEAccountKey", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RouterServer interface {
	...
	// Create an ACME account
	CreateACMEAccount(context.Context, *CreateACMEAccountRequest) (*CreateACMEAccountResponse, error)
	// Internal only. Get an ACME Account key
	GetACMEAccountKey(context.Context, *GetACMEAccountKeyRequest) (*GetACMEAccountKeyResponse, error)
}
...
func (*UnimplementedRouterServer) CreateACMEAccount(ctx context.Context, req *CreateACMEAccountRequest) (*CreateACMEAccountResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateACMEAccount not implemented")
}
func (*UnimplementedRouterServer) GetACMEAccountKey(ctx context.Context, req *GetACMEAccountKeyRequest) (*GetACMEAccountKeyResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetACMEAccountKey not implemented")
}
...
func _Router_CreateACMEAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateACMEAccountRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RouterServer).CreateACMEAccount(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/flynn.api.v1.Router/CreateACMEAccount",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RouterServer).CreateACMEAccount(ctx, req.(*CreateACMEAccountRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Router_GetACMEAccountKey_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetACMEAccountKeyRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RouterServer).GetACMEAccountKey(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/flynn.api.v1.Router/GetACMEAccountKey",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RouterServer).GetACMEAccountKey(ctx, req.(*GetACMEAccountKeyRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Router_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Router_CreateACMEAccount_Handler,
		},
		{
			MethodName: "GetACMEAccountKey",
			Handler:    _Router_GetACMEAccountKey_Handler,
		},
	},
