...
import (
	...
	"github.com/flynn/flynn/test/types"
)
...
func (c *Cluster) Boot(typ ClusterType, count int, buildLog *test.BuildLog, killOnFailure bool) (res *BootResult, err error) {
	if err := c.setup(); err != nil {
		return nil, err
	}
...
func (c *Cluster) DumpLogs(buildLog *test.BuildLog) {
